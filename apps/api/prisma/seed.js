...
async function main() {
    ...
    const superAdmin = await prisma.user.upsert({
        ...
        create: {
            ...
            roles: [client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ADMIN],
    ...
    const builder = await prisma.user.upsert({
        ...
        create: {
            ...
            phone: '9000000003',
            passwordHash: password,
            roles: [client_1.UserRole.BUILDER],
            status: client_1.UserStatus.ACTIVE,
            isEmailVerified: true,
            isPhoneVerified: true,
        },
    ...
    await prisma.orgMember.upsert({
        ...
        update: {},
        create: { userId: builder.id, orgId: builderOrg.id, role: client_1.UserRole.BUILDER, designation: 'Managing Director' },
    });
    ...
    const brokerOrg = await prisma.organization.upsert({
        ...
        create: {
            name: 'Skyline Realty',
            slug: 'skyline-realty',
            type: client_1.OrgType.BROKERAGE,
            phone: '08040000002',
    ...
    const broker = await prisma.user.upsert({
        ...
        create: {
            ...
            phone: '9000000004',
            passwordHash: password,
            roles: [client_1.UserRole.BROKER],
            status: client_1.UserStatus.ACTIVE,
            isEmailVerified: true,
            isPhoneVerified: true,
        },
    ...
    await prisma.orgMember.upsert({
        ...
        update: {},
        create: { userId: broker.id, orgId: brokerOrg.id, role: client_1.UserRole.BROKER },
    });
    // ─── Other Roles ──────────────────────────────────────────────────────────
    const roleUsers = [
        { name: 'Anand Buyer', email: 'buyer@buildestate.in', phone: '9000000005', role: client_1.UserRole.BUYER },
        { name: 'Suresh Contractor', email: 'contractor@buildestate.in', phone: '9000000006', role: client_1.UserRole.CONTRACTOR },
        { name: 'Meera Engineer', email: 'engineer@buildestate.in', phone: '9000000007', role: client_1.UserRole.SITE_ENGINEER },
        { name: 'Ramesh Supplier', email: 'supplier@buildestate.in', phone: '9000000008', role: client_1.UserRole.SUPPLIER },
    ];
    for (const u of roleUsers) {
        await prisma.user.upsert({
            ...
            create: {
                ...
                status: client_1.UserStatus.ACTIVE, isEmailVerified: true, isPhoneVerified: true,
            },
        });
    }
    // ─── Sample Project ───────────────────────────────────────────────────────
    ...
    await prisma.property.upsert({
        ...
        create: {
            ...
            transactionType: client_1.TransactionType.RESALE,
    ...
    await (0, categories_seed_1.seedMaterialCategories)();
